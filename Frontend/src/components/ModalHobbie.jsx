...
export function ModalHobbie({onCloselayClick,onOverlayClick, onHobbieSubmit}){
                ...
                <Container>
                    <StyledModal>
                        ...
                        <Body>
                            ...
                            <ListWrapper>
                            {ListCentreInteret.results.map((element)=>{
                                return(
                                ...
                                <SelectWrapper>
                                    {
                                        selections.map((element)=>{
                                           return(
                                            <ElementSelected>{element.name}</ElementSelected>
                                           )
                                        })
                                    }
                                </SelectWrapper>
...
export function Element({element}){
  ...
  console.log(selections);
    return(
        <ElementStyle etat={!isSelect} onClick={()=>{setSelect(!isSelect); saveReply(element)}}>
            <div>
                <UserImg src={element.image} key={`user${element.id}`} alt={`user${element.id}`} />
            </div>
            <div>
                <h1>
                    {element.name}
