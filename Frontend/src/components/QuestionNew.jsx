...
import { SelectionContext, MyQuestion } from "../utils/styles/Contexte";
...
function QuestionNew({onCloselayClick,onOverlayClick, onHobbieClick}){
    ...
    return(
        hobbie ?
        <ModalHobbie onOverlayClick={()=>{setHobbie(false)}} onCloselayClick={()=>{setHobbie(false)}} onHobbieSubmit={handleHobbieSubmit} /> :
        <div>                
                ...
                <Container>
                    <StyledModal>
                        <Head>
                            ...
                            <Foot>
                            <ButtonStyledCenter onClick={()=>{setHobbie(true)}}>Ajouter vos centres d'intérêts</ButtonStyledCenter>
                            <ButtonStyled text={validText} disabled={!text ? true : false} onClick={onCloselayClick} >Poser une question</ButtonStyled>
                        </Foot>
                    </StyledModal>
                </Container>
        </div>
